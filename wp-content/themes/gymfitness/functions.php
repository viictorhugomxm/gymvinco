<?php
  ...
  //Consultas reutilizablesa
  require get_template_directory() . '/includes/queries.php';
  // require get_template_directory() . '/includes/shortcodes.php';

  //Cuando el tema es activado
  function gymfitnes_setup_theme() {
  ...
  add_action('after_setup_theme', 'gymfitnes_setup_theme');
  ...
  function gymfitness_scripts_styles() {
    ...
    wp_enqueue_style('slicknavCSS', get_template_directory_uri() . '/css/slicknav.min.css',array(),'1.0');
    ...
    if(is_page('contacto')):
      wp_enqueue_script('leafletJS', 'https://unpkg.com/leaflet@1.7.1/dist/leaflet.js',array('jquery'),'2.11.3', true);
    endif;
