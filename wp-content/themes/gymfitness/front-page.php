<?php get_header('front'); ?>
  ...
  <section class="clases">
    <div class="contenedor seccion">
      ...
      <div class="contenedor-boton">
        <a href="<?php echo esc_html(get_permalink(get_page_by_title('Nuestras Clases'))); ?>" class="boton boton-primario">
  ...
  <section class="testimoniales">
    <h2 class="text-center texto-blanco">Experiencias</h2>
